...
fprintf('\n');
disp('or by:');
disp('>> mpt_plotTimeTrajectory(ctrlStruct)');
fprintf('\n');
...
pause
load ltiDIft
mpt_plotTrajectory(ctrlStruct);
fprintf('\n\n');
disp('If you want to use mpt_plotTimeTrajectory, the reference point has to be given in the Options as follows:');
disp('>> Options.reference = [-4; 0];');
disp('>> mpt_plotTimeTrajectory(ctrlStruct, [2;2], [], Options);');
Options.reference=[-4;0];
mpt_plotTimeTrajectory(ctrlStruct, [2;2], [], Options);
fprintf('\n\n');
...
load ltiDIrt
mpt_plotTrajectory(ctrlStruct);
mpt_plotTimeTrajectory(ctrlStruct, [0;0], []);
fprintf('\n\n');
