...
% Last Modified by GUIDE v2.5 11-Apr-2005 12:30:21
...
'ListboxTop',0,...
'Position',[5.4 23.2307692307692 3.4 1.15384615384615],...
'String','A',...
'Style','text',...
'Tag','text1');
...
'HorizontalAlignment','right',...
'ListboxTop',0,...
'Position',[7 21.3076923076923 1.6 1.15384615384615],...
'String','B',...
'Style','text',...
'Tag','text2');
...
'HorizontalAlignment','right',...
'ListboxTop',0,...
'Position',[7 19.4615384615385 1.6 1.15384615384615],...
'String','f',...
'Style','text',...
'Tag','text_fdyn',...
'Visible','off');
...
'HorizontalAlignment','right',...
'ListboxTop',0,...
'Position',[6.4 15 1.6 1.53846153846154],...
'String','C',...
'Style','text',...
'Tag','text3');
...
'HorizontalAlignment','right',...
'ListboxTop',0,...
'Position',[6.4 13.0769230769231 1.6 1.15384615384615],...
'String','D',...
'Style','text',...
'Tag','text4');
...
'HorizontalAlignment','right',...
'ListboxTop',0,...
'Position',[6.2 11 1.6 1.15384615384615],...
'String','g',...
'Style','text',...
'Tag','text_gdyn',...
'Visible','off');
...
%   $Revision: 1.8 $ $Date: 2005/04/11 10:34:14 $
